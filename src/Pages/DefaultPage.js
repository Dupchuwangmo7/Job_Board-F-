...
<header className="flex justify-between items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-500 text-white shadow-lg sticky top-0 z-50">
  ...
  <nav className="hidden md:flex space-x-6">
    ...
    <a href="#" className="text-white hover:text-blue-300">Companies</a>
  </nav>
  <div className="flex space-x-6">
    <Link to="/sign-in" className="text-white hover:text-blue-300">Sign In</Link>
    <Link to="/sign-up" className="text-white hover:text-blue-300">Sign Up</Link>
  </div>
</header>
      ...
      <section className="bg-gray-50 py-16 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-lg text-gray-600">Join the revolution of young Bhutanese professionals shaping tomorrow's industries.</p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-teal-400 to-blue-500 py-16 text-center text-white">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-xs">
            <h3 className="text-xl font-semibold text-blue-500">Transparency First</h3>
            <p className="mt-4 text-gray-700">No more guessing. See job details, salary, and more upfront, so you make informed decisions.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-xs">
            <h3 className="text-xl font-semibold text-blue-500">Connecting You Directly</h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-12">
            <div className="w-64 bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="mt-4 text-blue-500 font-semibold">Tashi Dorji, Web Developer</div>
            </div>
            <div className="w-64 bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="mt-4 text-blue-500 font-semibold">Sonam Lhamo, Digital Marketer</div>
            </div>
          </div>
        </div>
      </section>
